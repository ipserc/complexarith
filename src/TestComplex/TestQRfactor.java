...
public class TestQRfactor {
	...
	public static void main(String[] args) {
    	...
    	fMatrix = new QRfactor(4);fMatrix.initMatrixRandomRecInt(9);fMatrix.qrHouseholder();
    	showResults(fMatrix);
    	//fMatrix = new QRfactor(4);fMatrix.initMatrixRandomInteger(9);
		fMatrix = new QRfactor("1,2,3,0;1,2,0,0;1,0,0,1");fMatrix.qrGramSchmidt();
    	showResults(fMatrix);
		fMatrix = new QRfactor("1,1,1;2,2,0;3,0,0;0,0,1");fMatrix.qrGramSchmidtFull();
    	showResults(fMatrix);
    	fMatrix = new QRfactor(4,6);fMatrix.initMatrixRandomInteger(9);fMatrix.qrHouseholder();
    	showResults(fMatrix);
    	fMatrix = new QRfactor(6,4);fMatrix.initMatrixRandomInteger(9);fMatrix.qrHouseholder();
    	showResults(fMatrix);
		fMatrix = new QRfactor(6,6);fMatrix.initMatrixRandomInteger(9);fMatrix.qrHouseholder();
    	showResults(fMatrix);
		fMatrix = new QRfactor(3,3);fMatrix.initMatrixRandomRecInt(9);fMatrix.qrHouseholder();
    	showResults(fMatrix);
		fMatrix = new QRfactor("1-i,1,i;1,-5i,1;3+2i,1,1");fMatrix.qrHouseholder();
    	showResults(fMatrix);
    	
		System.out.println(Complex.boxTitleRandom(boxSize, " - - - QR Householder - - -"));   	
		fMatrix = new QRfactor(3,3);fMatrix.initMatrixRandomRec(9);fMatrix.qrHouseholder();
    	showResults(fMatrix);
