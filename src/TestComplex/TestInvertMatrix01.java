...
public class TestInvertMatrix01 {
	public static void showResults(MatrixComplex aMatrix) {
    	MatrixComplex bMatrix;
		int boxSize = 65;

		System.out.println(Complex.boxTitleRandom(boxSize, "MATRIX OPERATIONS TEST"));

		System.out.println(Complex.boxTextRandom(boxSize, "Matrix Triangle & Determinant"));
