 ...
 */
public class TestTaylorLogExp05 {
	...
	public static void printHeader(MatrixComplex aMatrix) {
    	Complex.printBoxTitle(3, boxSize, "logarithm base 10 of Matrix Test");
     	...
     	System.out.println("aMatrix = " + aMatrix.toWolfram());
	    	...
	    	bMatrix = aMatrix.log10(); 
	       	if (!bMatrix.isInfinite() && !bMatrix.isNaN()) {
		    	...
		    	Complex.printBoxText(3, boxSize, "logarithm in base 10");
	         	...
	         	System.out.println("bMatrix = " + bMatrix.toWolfram());
	        	System.out.println("bMatrix = " + bMatrix.toMatrixComplex());
    ...
    public static void main(String[] args) {
    	...
    	if (complex) 
    		...
    		aMatrix.initMatrixRandomInt(33); // Integer Numbers
