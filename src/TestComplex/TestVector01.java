...
public class TestVector01 {
	...
	public static void main(String[] args) {
    	...
    	aVector = new Vector(" 1, 1, 1");
    	bMatrix.base(" .5, 0, 0; 0, 0.33333333333333333, 0; 0, 0, .25");
       	cambioBase(aVector, bMatrix);

    	aVector = new Vector(" 1, 1, 1");
    	bMatrix.base(" 0, 0.33333333333333333, 0;  .5, 0, 0; 0, 0, .25");
       	cambioBase(aVector, bMatrix);

       	aVector = new Vector(" -2, 0, 1");
       	cambioBase(aVector, bMatrix);

    	aVector = new Vector(" -3, -5, 4");
       	cambioBase(aVector, bMatrix);

    	aVector = new Vector(" 6, 9, 14");
    	bMatrix.base(" 1, i, 1; -i, 1, 2+i; 1, 2-i, 3i");
       	cambioBase(aVector, bMatrix);
