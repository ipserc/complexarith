...
public class TestMatrixOperators02 {
	...
	public static void main(String[] args) {
    	...
    	System.out.println();
   		...
   		Complex.printBoxTitleRandom(boxSize, "MATRIX TRIGONOMETRICS");
   		aMatrix.println("aMatrix");
		Complex.printBoxTitleRandom(boxSize, "SIN OPERATOR");
		Complex.printBoxTextRandom(boxSize, "--- sin() ---");
		bMatrix = aMatrix.sin();
		bMatrix.println();
		Complex.printBoxTextRandom(boxSize, "--- ssin() ---");
		cMatrix = aMatrix.ssin();
		cMatrix.println();
		
		Complex.sin(aMatrix.determinant()).println("Complex.sin(aMatrix.determinant()):");
		bMatrix.determinant().println(             "sin(aMatrix).determinant()........:");
		cMatrix.determinant().println(             "ssin(aMatrix).determinant().......:");

		
		Complex.printBoxTitleRandom(boxSize, "COS OPERATOR");
		Complex.printBoxTextRandom(boxSize, "--- cos() ---");
		dMatrix = aMatrix.cos();
		dMatrix.println();
		Complex.printBoxTextRandom(boxSize, "--- ccos() ---");
		eMatrix = aMatrix.ccos();
		eMatrix.println();

		Complex.cos(aMatrix.determinant()).println("Complex.sin(aMatrix.determinant()):");
		dMatrix.determinant().println(             "cos(aMatrix).determinant()........:");
		eMatrix.determinant().println(             "ccos(aMatrix).determinant().......:");

		
		Complex.printBoxTitleRandom(boxSize, "TAN OPERATOR");
		Complex.printBoxTextRandom(boxSize, "--- tan() ---");
		fMatrix = aMatrix.tan();
		fMatrix.println();
		Complex.printBoxTextRandom(boxSize, "--- ttan() ---");
		gMatrix = aMatrix.ttan();
		gMatrix.println();

		Complex.tan(aMatrix.determinant()).println("Complex.tan(aMatrix.determinant()):");
		fMatrix.determinant().println(             "tan(aMatrix).determinant()........:");
		gMatrix.determinant().println(             "ttan(aMatrix).determinant().......:");
		
		
		Complex.printBoxTitleRandom(boxSize, "CHECK TAN OPERATOR");
		Complex.printBoxTextRandom(boxSize, "--- tan() = sin()/cos() ---");
		hMatrix = bMatrix.divides(dMatrix);
		hMatrix.println();

		Complex.printBoxTextRandom(boxSize, "--- ttan() = ssin()/ccos() ---");
		iMatrix = cMatrix.divides(eMatrix);
		iMatrix.println();

	  	System.out.println();
	  	Complex.printBoxTitleRandom(boxSize, "MATRIX HYPERBOLICS");
   		aMatrix.println("aMatrix");
		Complex.printBoxTitleRandom(boxSize, "SINH OPERATOR");
		Complex.printBoxTextRandom(boxSize, "--- sinh() ---");
		bMatrix = aMatrix.sinh();
		bMatrix.println();
		Complex.printBoxTextRandom(boxSize, "--- ssinh() ---");
		cMatrix = aMatrix.ssinh();
		cMatrix.println();

		Complex.sinh(aMatrix.determinant()).println("Complex.sinh(aMatrix.determinant()):");
		bMatrix.determinant().println(              "sinh(aMatrix).determinant()........:");
		cMatrix.determinant().println(              "ssinh(aMatrix).determinant().......:");

		
		Complex.printBoxTitleRandom(boxSize, "COSH OPERATOR");
		Complex.printBoxTextRandom(boxSize, "--- cosh() ---");
		dMatrix = aMatrix.cosh();
		dMatrix.println();
		Complex.printBoxTextRandom(boxSize, "--- ccosh() ---");
		eMatrix = aMatrix.ccosh();
		eMatrix.println();

		Complex.printBoxTitleRandom(boxSize, "TANH OPERATOR");
		Complex.printBoxTextRandom(boxSize, "--- tanh() ---");
		fMatrix = aMatrix.tanh();
		fMatrix.println();
		Complex.printBoxTextRandom(boxSize, "--- ttanh() ---");
		gMatrix = aMatrix.ttanh();
		gMatrix.println();

		Complex.printBoxTitleRandom(boxSize, "CHECK TANH OPERATOR");
		Complex.printBoxTextRandom(boxSize, "--- tanh() = sinh()/cosh() ---");
		hMatrix = bMatrix.divides(dMatrix);
		hMatrix.println();

		Complex.printBoxTextRandom(boxSize, "--- ttanh() = ssinh()/ccosh() ---");
		iMatrix = cMatrix.divides(eMatrix);
		iMatrix.println();
