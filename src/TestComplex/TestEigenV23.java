...
public class TestEigenV23 {
	 ...
	 */
	 ...
	 public static void main(String[] args) {
		...
		/* */
		/* * /
		aMatrix = new MatrixComplex(3); aMatrix.initMatrixRandomReal();
		aMatrix.hermitian();
		//aMatrix = aMatrix.times(aMatrix.adjoint()); 
		aMatrix = aMatrix.orthogonalize();
		//aMatrix = aMatrix.normalize();
		//aMatrix = aMatrix.orthonormalize();
		/* */
		...
		//aMatrix = aMatrix.normalize();
		// new MatrixComplex("-0.6035,-0.1006,+0.2092,+0.4667,-0.6035;+0.1336,+0.2616,-0.7340,+0.6109,+0.0408;+0.6266,-0.5899,+0.2538,+0.4278,-0.1095;+0.4569,+0.6885,+0.2892,-0.0150,-0.4830;+0.1288,-0.3153,-0.5190,-0.4751,-0.6236");
		/* * /
		aMatrix = new MatrixComplex("+1,-3,+2,+2,-1;"+
									"+3,-1,+4,+4,+1;"+
									"+4,-4,+6,+6,+0;"+
									"+5,-7,+8,+8,-1;"+
									"+2,-6,+4,+4,-2");
