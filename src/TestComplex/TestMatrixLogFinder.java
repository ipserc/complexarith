...
public class TestMatrixLogFinder {
    ...
    public static void main(String[] args) {
		...
		aMatrix = new MatrixComplex(3);
   		//aMatrix.initMatrixRandomReal(9);
   		//aMatrix.initMatrixRandomRec();
   		//aMatrix.initMatrixRandomRecInt(9);
   		aMatrix.initMatrixRandomInt(99);
   		//aMatrix.initMatrixRandomRec(99);
    	...
    	} while (bMatrix.isInfinite());
        
		Complex.printBoxTextRandom(boxSize, "Natural logarithm Matrix functions - Transpose");
        cMatrix = aMatrix.transpose();
		cMatrix.println("cMatrix");
       	System.out.println("cMatrix = " + cMatrix.toMatrixComplex());
    	cMatrix.determinant().println("C Det=");   	
        bMatrix = cMatrix.log(); 
        bMatrix.println("b=log");
        bMatrix.exp().println("exp(b)");
        
		Complex.printBoxTextRandom(boxSize, "Natural logarithm Matrix functions - Adjoint");
        dMatrix = aMatrix.adjoint();
		dMatrix.println("dMatrix");
       	System.out.println("dMatrix = " + dMatrix.toMatrixComplex());
    	dMatrix.determinant().println("D Det=");   	
        bMatrix = dMatrix.log(); 
        bMatrix.println("b=log");
        bMatrix.exp().println("exp(b)");
    }
