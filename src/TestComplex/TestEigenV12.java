...
public class TestEigenV12 {
	...
	public static void main(String[] args) {
    	...
    	int boxSize = 65;
     	...
     	/* */
      	System.out.println(Complex.boxTitleRandom(boxSize, "EIGENVALUES & EIGENVECTORS PRECISION TEST"));
     	...
     	Complex.facts();
     	doEigenCalculations(aMatrix);
     	System.out.println(Complex.boxTitleRandom(boxSize, " --- END EIGENVALUES & EIGENVECTORS PRECISION TEST END ---"));
     	/* */
