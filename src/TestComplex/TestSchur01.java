    	...
    	int iteration = 0;
  		...
  		do {
  	    	...
  	    	//aMat = new MatrixComplex("+7.0000E+00,+6.0000E+00,+2.0000E+00;+7.0000E+00,+6.0000E+00,-6.0000E+00;-4.0000E+00,+4.0000E+00,-7.0000E+00");
				...
				Schurfactor aMatSchur = new Schurfactor(aMat);
		    	System.out.println("aMat = "+aMat.toMatrixComplex());
				Complex.printBoxTextRandom(boxSize, "aMatSchur factorized:" + aMatSchur.factorized());
				if (aMatSchur.factorized()) 
				{
			    	aMat.println("aMat");
					U = aMatSchur.getU(); 
					U.println(Complex.boxTextRandom(boxSize, "SOLUTION U (Method:Inverse)"));
					Complex.printBoxTextRandom(boxSize, " U is unitary:" + U.isUnitary());
					schur = aMatSchur.getSchur();
					schur.println(Complex.boxTextRandom(boxSize, "SOLUTION SCHUR (Method:Inverse):"));
					retry = false;
					Complex.printBoxTitleRandom(boxSize, "CHECK FACTORIZACIÓN SCHUR (Method:Inverse) = ZERO");
