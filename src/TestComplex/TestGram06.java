...
public class TestGram06 {
	...
	public static void showResults(MatrixComplex aMatrix) {
		...
		System.out.println("Gram-Schmidt Matrix is orthogonal:" + gMatrix.isOrthogonal());
		...
		System.out.println("Gram-Schmidt Matrix Normalized (GN) is orthogonal:" + gnMatrix.isOrthogonal());
		System.out.println("Gram-Schmidt Matrix Normalized (GN) is orthonormal:" + gnMatrix.isOrthonormal());
		...
		***********************/
		...
		if (aMatrix.isSquare()) {
			...
			//gnMatrix = gMatrix.normalizeByCols();
			gnMatrix = aMatrix.orthonormalize();
	...
	public static void main(String[] args) {
		...
		" 3.000+4.000i , -1.000+4.000i , -6.000+5.000i ;" +
		"-6.000+6.000i ,  1.000+2.000i ,  3.000+6.000i ;" +
		"-4.000+1.000i ,  3.000-2.000i ,  6.000-2.000i ;" +
		"-3.000-1.000i ,  2.000-1.000i ,  1.000+2.000i  "); 
		System.out.println(Complex.boxTitleRandom(boxSize, "++++++ MATRIX 4x3 ++++++"));
		showResults(aMatrix);		

		aMatrix = new MatrixComplex(""+
		"-1.000+2.000i , -6.000-3.000i ,  1.000-2.000i , -2.000-3.000i ;" +
		"-6.000+4.000i ,  6.000+1.000i , -6.000+1.000i ,  1.000-2.000i ;" + 
		"-5.000+3.000i ,  1.000+1.000i ,  4.000+5.000i ,  3.000-2.000i ");
		System.out.println(Complex.boxTitleRandom(boxSize, "++++++ MATRIX 3x4 ++++++"));
		showResults(aMatrix);		

		aMatrix = new MatrixComplex("" +
		" 3.000+4.000i , -1.000+4.000i , -6.000+5.000i, -6.000-3.000i ;" +
		"-6.000+6.000i ,  1.000+2.000i ,  3.000+6.000i,  4.000+5.000i ;" +
		"-4.000+1.000i ,  3.000-2.000i ,  6.000-2.000i,  1.000-2.000i ;" +
		"-3.000-1.000i ,  2.000-1.000i ,  1.000+2.000i,  3.000-2.000i  "); 
