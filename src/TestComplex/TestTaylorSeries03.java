 ...
 *  funciones trigonom�tricas y trigonom�tricas hiperb�licas entre  matrices 
 *  para valores enteros, reales y complejos.
 *  
 *  El m�todo de chequeo consiste comprobar las siguientes propiedades:
 *  1. F�rmula de euler exp(i*A) = cos(A)+i*sin(A)
 *  2. cos^2(A)+sin^2(A) = I
 *  3. cosh^2(A)-sinh^2(A) = I
 *  D�nde I es la matriz Identidad o matriz Unitaria
 *  
