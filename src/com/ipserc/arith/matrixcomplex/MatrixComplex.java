...
public class MatrixComplex {
	...
	/**
	 * Enables the presentation in scientific format of the numbers.
	 * /
	public void setFormatON() { 
		this.complexMatrix[0][0].setFormatON();
	}

	/**
	 * Disables the presentation in scientific format of the numbers.
	 * /
	public void setFormatOFF() { 
		this.complexMatrix[0][0].setFormatOFF();
	}

	/**
	 * Returns the status of the scientific format flag.
	 * @return Status of scientific format flag.
	 * /
	public boolean getFormatStatus() {
		return this.complexMatrix[0][0].getFormatStatus();
	}

	/**
	 * Sets the maximum number of decimal digits that are presented in scientific format.
	 * @param maxDigits Maximum number of decimal digits to display.
	 * /
	public void setMaxDigits(int maxDigits) {
		this.complexMatrix[0][0].setMaxDigits(maxDigits);
	}

	/**
	 * Returns the maximum number of decimal digits that are displayed when the scientific format is activated.
	 * @return Maximum number of decimal digits that are displayed.
	 * /
	public int getMaxDigits() {
		return this.complexMatrix[0][0].getMaxDigits();
	}

	/**
	 * Sets the minimum number of decimal digits that are presented in scientific format.
	 * @param minDigits Minimum number of decimal digits to display.
	 * /
	public void setMinDigits(int minDigits) {
		this.complexMatrix[0][0].setMinDigits(minDigits);
	}

	/**
	 * Returns the minimum number of decimal digits that are displayed when the scientific format is activated.
	 * @return Minimum number of decimal digits that are presented.
	 * /
	public int getMinDigits() {
		return this.complexMatrix[0][0].getMinDigits();
	}

	/**
	 * Enables fixed-point format.
	 * /
	public void setFixFloatON() { 
		this.complexMatrix[0][0].setFixFloatON();
	}

	/**
	 * Enables the fixed-point format to a maximum number of digits.
	 * @param maxDigits Maximum number of digits to display.
	 * /
	public void setFixFloatON(int maxDigits) { 
		this.complexMatrix[0][0].setFixFloatON(maxDigits);
	}

	/**
	 * Disables the fixed-point format.
	 * /
	public void setFixFloatOFF() { 
		this.complexMatrix[0][0].setFixFloatOFF();
	}

	/**
	 * Returns the status of the fixed-point format flag.
	 * @return The status of the fixed-point format flag.
	 * /
	public boolean getFixFloatStatus() {
		return this.complexMatrix[0][0].getFixFloatStatus();
	}
	*/
